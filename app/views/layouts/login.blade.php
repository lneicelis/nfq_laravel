...
<html lang="en">
	<head>
		...
		<!-- URL5 shim and Respond.js IE8 support of URL5 elements and media queries -->
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
                                                @include('resources.alerts', array('alerts', $alerts))
											</h4>

											<div class="space-6"></div>

											<form method="POST" action="{{ URL::to('user/login') }}" autocomplete="on">
												<fieldset>
