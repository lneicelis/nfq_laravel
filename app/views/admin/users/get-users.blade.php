...
@section('head-css')
    ...
    <link rel="stylesheet" href="{{ URL::asset('assets/css/jquery-ui-1.10.3.full.min.css') }}" />
    <link rel="stylesheet" href="{{ URL::asset('assets/css/datepicker.css') }}" />
    <link rel="stylesheet" href="{{ URL::asset('assets/css/ui.jqgrid.css') }}" />
    @parent
...
<script src="{{ URL::asset('assets/js/jqGrid/jquery.jqGrid.min.js') }}"></script>
<script src="{{ URL::asset('assets/js/jqGrid/i18n/grid.locale-en.js') }}"></script>

<script type="text/javascript">
var grid_data = {{ json_encode($users) }};
...
jQuery(function($) {
    ...
    jQuery(grid_selector).jqGrid({
        ...
        datatype: "local",
        height: 'auto',
        colNames:[' ', 'ID','Email', 'First name','Last name', 'Group', 'Created at', 'Activated at'],
        colModel:[
        ...
        editurl: "{{ URL::action('UsersController@postUserEdit') }}",//nothing is saved
        caption: "All users",
