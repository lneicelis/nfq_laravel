...
@section('content')
    <p><a href="{{ URL::to('gallery/new-album') }}">Create a new album</a></p>
    ...
    <ul class="ace-thumbnails">
        ...
        <li style="width: 200px; height: 200px">
            <a href="{{ URL::to('album/' . $album->id) }}" title="{{ $album->title }}" >

                @if(!empty($album->file_name))
                    <img alt="200x200" src="{{ URL::asset('thumbs/' . $album->file_name) }}" />
                @else
                    <img alt="200x200" src="{{ URL::asset('thumbs/' . $default_cover) }}" />
                @endif
            ...
            <div class="tools">
                ...
                <a href="{{ URL::to('album/destory/' . $album->id) }}">
    ...
    <div id="album-edit-modal-form" class="modal" tabindex="-1">
        <div class="modal-dialog">
            <form method="post" action="{{ URL::to('album/edit') }}">
